...
- Line 53: Load 16-bit TCP window field
- Line 54: Convert from big-endian to native endian
- Line 55: \textbf{Call function with 16-bit value in a 64-bit register}
...
\begin{verbatim}
python3 src/exploits/5_06d_argcomp/exploit_506d.py <VM_IP>
\end{verbatim}
