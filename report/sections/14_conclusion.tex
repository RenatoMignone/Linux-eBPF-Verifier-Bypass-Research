...
\begin{itemize}
  ...
  \item \textbf{Feasible to exploit} for privilege escalation with additional effort
\end{itemize}
...
\hline
5.46b & Buffer Overflow & Privilege escalation to root & CRITICAL \\
5.39 & Stack OOB Write & Memory corruption, potential code execution & HIGH \\
